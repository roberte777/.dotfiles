#!/bin/sh
sudo mkdir -p /data/{torrents/{movies,tv,books,audiobooks,completed,incomplete},usenet/{complete/{movies,tv,books,audiobooks},incomplete},media/{movies,tv,books,audiobooks}}
