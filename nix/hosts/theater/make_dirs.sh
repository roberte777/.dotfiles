...
sudo mkdir -p /docker/appdata/{gluetun,qbittorrent,qbittorrent-mam,mousehole,prowlarr,radarr,sonarr,flaresolverr,jellyfin,seerr,audiobookshelf,calibre,calibre-web,sabnzbd,shelfarr,profilarr,homarr,portainer,vaultwarden,tautulli,omnibus/{config,cache}}
