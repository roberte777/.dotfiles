	...
	config = function()
		...
		local on_attach = function(client, bufnr)
			...
			if client.name == "rust_analyzer" then
				...
				keymap.set("n", "<leader>lt", "<cmd>!cargo test<cr>", opts)

				-- opts.desc = "Code Actions"
				-- keymap.set("n", "<leader>la", rt.code_action_group.code_action_group, opts) -- show documentation for what is under cursor
			end
		end
